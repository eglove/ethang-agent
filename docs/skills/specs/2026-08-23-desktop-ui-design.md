...
- System-prompt providers (`SkillsBootstrapPromptProvider`, `ExecGuidePromptProvider`, `CuratedMemoryGuidePromptProvider`, static prompt — moved from CLI)
...
| Move | `SkillsBootstrapPromptProvider.cs`, `ExecGuidePromptProvider.cs`, `InMemoryConversationRepository.cs` from CLI |
