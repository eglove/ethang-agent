...
**Goal:** Give the model safe, strictly-validated `write`, `edit`, and `search_files` tools through the FileSystem ACL, per spec `docs/skills/specs/2026-08-21-stage-1-methodology-port-design.md` (SP1).
