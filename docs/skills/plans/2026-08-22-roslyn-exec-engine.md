...
**Spec:** `docs/skills/specs/2026-08-22-untangle-powershell-design.md`
...
- [ ] **Step 3: Update SkillsBootstrapPromptProvider**

In `src/eThangAgent.CLI/SkillsBootstrapPromptProvider.cs`, change:
