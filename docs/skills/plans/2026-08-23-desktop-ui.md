...
**Spec:** `docs/skills/specs/2026-08-23-desktop-ui-design.md`
...
- Move: `src/eThangAgent.CLI/SkillsBootstrapPromptProvider.cs` → `src/eThangAgent.Composition/SkillsBootstrapPromptProvider.cs`
...
- Modify: `tests/eThangAgent.CLI.Tests/SkillsBootstrapTests.cs` — add `using eThangAgent.Composition;` if it referenced the old namespace directly

**Interfaces:**

- Produces: `SkillsBootstrapPromptProvider`, `ExecGuidePromptProvider`, `CuratedMemoryGuidePromptProvider : ISystemPromptProvider`, `InMemoryConversationRepository : IConversationRepository` — consumed by name in Task 7 wiring.

- [ ] **Step 1: Perform the moves** (git-tracked rename + namespace edit; bodies verbatim)

```powershell
git mv src/eThangAgent.CLI/SkillsBootstrapPromptProvider.cs src/eThangAgent.Composition/
...
Expected: green; SkillsBootstrap tests pass against the relocated provider.
