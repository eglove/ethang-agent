...
3. Superpowers bootstrap injected exactly once per session into the system message
...
**Relocations:**
- `SuperpowersBootstrapTests` (pure Composition contracts) → `Composition.Tests`
