...
**Spec:** docs/superpowers/specs/2026-08-21-async-agents-mesh-design.md — the plan argues from the spec; executors read both.
...
- Modify: `docs/superpowers/plans/2026-08-21-async-agents-mesh.md` (this file — checkbox marks + Outcome section)
