...
**Goal:** Give the model typed, strictly-validated git tools — `git_status`, `working_diff`, `git_commit` (conventional / gitmoji / none styles, native emoji table, no npm) — through the PowerShell ACL, per spec `docs/superpowers/specs/2026-08-21-stage-1-methodology-port-design.md` (SP3).
