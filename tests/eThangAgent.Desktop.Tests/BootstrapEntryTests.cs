...
/// any content. Names the production change that would fail each test:
/// removing the constructor append empties the entry list / reorders restore.
/// </summary>
public class BootstrapEntryTests
{
  ...
  private static AgentSessionViewModel Build()
  {
