...
- **Session retrospective**: at the end of every session/task, evaluate the session for bugs encountered, improvements worth making, and new tools or skills that could be built into the agent, and include that evaluation in the summary to the user rather than letting it evaporate.
