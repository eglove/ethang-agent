...
public static partial class CuratedMemorySpecifications
{
    ...
    {
        "convention" => Result<MemoryCategory>.Success(MemoryCategory.Convention),
        "preference" => Result<MemoryCategory>.Success(MemoryCategory.Preference),
        "insight" => Result<MemoryCategory>.Success(MemoryCategory.Insight),
        "failure" => Result<MemoryCategory>.Success(MemoryCategory.Failure),
        "reference" => Result<MemoryCategory>.Success(MemoryCategory.Reference),
        _ => Result<MemoryCategory>.Failure(new Error(
            "InvalidCategory",
    ...
    {
        "workspace" => Result<MemoryScope>.Success(MemoryScope.Workspace),
        "global" => Result<MemoryScope>.Success(MemoryScope.Global),
        _ => Result<MemoryScope>.Failure(new Error(
            "InvalidScope",
