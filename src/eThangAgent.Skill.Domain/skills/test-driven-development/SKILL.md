...
description: Drive new code with failing tests written first, then minimal passing implementations, then refactoring. Use when implementing any feature or bugfix with testable behavior.
---
