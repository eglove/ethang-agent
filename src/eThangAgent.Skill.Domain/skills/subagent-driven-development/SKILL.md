...
description: Execute plan tasks through fresh subagents with two-stage review between tasks. Use when a plan has independent tasks that benefit from isolated execution and review.
---
